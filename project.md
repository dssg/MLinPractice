...
Each milestone is a Canvas assignment — see [Assignments & Grading]({{ '/grading/' | relative_url }}).
...
See [Assignments & Grading]({{ '/grading/' | relative_url }}) for the full list
of Canvas assignments, due dates, points, and the rubric applied to the final
writeup, demo, and presentation.
